...
Процедура ПриСозданииНаСервере(Форма, Знач ПараметрыРазмещения = Неопределено) Экспорт
	...
	// Д/З Нетология
	ДополнитьФорму(Форма);// Дополняет форму полями и командами заказчика
	// Д/З Нетология
...
// Новая область
// Мерзляков А.А. Д/З Нетология от 29.07.202
// Добавление Функционала при создании формы: обращение к созданному модулю ДЗ_РаботаСФормами

Функция ДополнитьФорму(Форма)// Дополняет форму полями и командами заказчика
